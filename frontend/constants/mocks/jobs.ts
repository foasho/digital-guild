...
export const izakayaJob: Job = {
  ...
  capacity: 2,
  checklist: [
    { id: "check-1-1", text: "集合場所に到着" },
    { id: "check-1-2", text: "機材のセッティング完了" },
    { id: "check-1-3", text: "撮影補助完了" },
    { id: "check-1-4", text: "片付け完了" },
  ],
...
export const noukaJob: Job = {
  ...
  capacity: 5,
  checklist: [
    { id: "check-2-1", text: "農園に到着・受付完了" },
    { id: "check-2-2", text: "収穫道具の受け取り" },
    { id: "check-2-3", text: "午前の収穫作業完了" },
    { id: "check-2-4", text: "午後の収穫作業完了" },
    { id: "check-2-5", text: "道具の返却・作業報告" },
  ],
...
export const ryokanJob: Job = {
  ...
  capacity: 3,
  checklist: [
    { id: "check-3-1", text: "旅館フロントで受付" },
    { id: "check-3-2", text: "清掃道具の準備" },
    { id: "check-3-3", text: "庭園の落ち葉掃除完了" },
    { id: "check-3-4", text: "石畳の清掃完了" },
    { id: "check-3-5", text: "道具の片付け・作業報告" },
  ],
